...
class TheaterCrawler:
    ...
    @staticmethod
    async def get_gu_list(sWideareaCd: str):
    ...
    @staticmethod
    async def get_theater_list(sBasareaCd: str):
        ...
        for idx in range(len(data)):
            cdNm = data[idx]["cdNm"]
            del data[idx]["cdNm"]
            info = await TheaterCrawler.get_coordinate(cdNm)
            data[idx]["info"] = info
    ...
    @staticmethod
    async def get_coordinate(address: str):
        result = ""
